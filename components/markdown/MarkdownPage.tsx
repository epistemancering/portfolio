...
export default function MarkdownPage(props: { page: string, supplement?: string }) {
    return <>
        <header style = {{ borderBottomStyle: "solid", borderWidth: "1px", padding: "0 24px", display: "flex", justifyContent: "center" }} className = {"text-gray9 dark:text-gray2"}>
            <div style = {{ width: "1280px" }} className = {"text-center lg:text-left"}>
                <MarkdownParent page = {props.page} supplement = {props.supplement} />
                <h1 className = {`mt-0 lg:mt-[11px] text-[42px] lg:text-7xl text-gray0 dark:text-gray11`} style = {{ marginBottom: "16px", lineHeight: 1.1, fontWeight: 600, fontFamily: "Rubik" }}>
                ...
                <div style = {{ padding: "8px", display: "flex", justifyContent: "space-between", rowGap: "24px", alignItems: "center", columnGap: "40px" }} className = {"flex-col lg:flex-row"}>
                    ...
                    <p style = {{ margin: 0, lineHeight: "30px", fontSize: "20px" }} className = {"text-gray3 dark:text-gray8"}>
